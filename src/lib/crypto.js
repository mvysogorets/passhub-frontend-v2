...
const encryptPrivateKey = (cPrivateKey, ticket) => {
  WebCryptoPrivateKey = cPrivateKey;
...
function setPublicKey(aKey) {
  publicKeyPem = aKey;
}


export {
  encryptPrivateKey, // create user
  setPublicKey,  // crteate user
  getPrivateKey,
  decryptAesKey,
  encryptAesKey,
  decodeItem,
